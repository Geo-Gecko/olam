...
axios.all(requests_)
  .then(responseArr => {
    ...
    console.log(farm_dates)
    Plotly.newPlot(
      'farmComparisonContainer',
      ndvi_mean_data,
      {
        title: {
          text: `Farm Comparison for Zambia`,
          font: {
...
//   data.forEach(ft => ft.features.forEach(f => console.log(f.id)))
// }, 10000)
